...
# ========== STEP 3: 실제 호출 및 출력 ==========
# 설정값 입력
api_url = 'https://a4dyolhyl2.apigw.ntruss.com/custom/v1/40636/e9a63827526c61487a35ffaa58677583b4b95176dd8359fdd514d361674b7a65/general'  # 실제 Invoke URL로 수정
secret_key = '------------------'  # 실제 Secret Key로 수정